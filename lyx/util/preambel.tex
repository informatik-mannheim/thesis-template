...
% \usepackage{lastpage}           % totpages wird stattdessen über cc eingebunden.

% Setzen von Optionen abhängig von der gewählten Sprache. Die Sprache wird
% in thesis.tex gesetzt.
\ifthenelse{\equal{\hsmasprache}{de}}%
  {%
   %\usepackage[main=ngerman, english]{babel}             % Deutsche Sprachunterstützung (hier über Lyx)
   \usepackage[autostyle=true,german=quotes]{csquotes}    % Deutsche Anführungszeichen
   %\usepackage[pagebackref=false,german]{hyperref}       % Hyperlinks (hier über Lyx)
...
% Die nachfolgenden Angaben aus der TeX-Version führen zu Fehlern mit Lyx, da die
% Parameter dort über Lyx-Einstellungen gesetzt werden.
