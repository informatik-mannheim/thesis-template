...
% getrennt, z.B. Datenschutz-Grundverordnung. Bei diesen Wötern müssen
% Sie LaTeX helfen, wenn Sie über den Seitenrand herausstehen,
% idem Sie weitere Trennstellen angeben. Dies geschieht durch
% "- als Zeichen, z.B. Daten"-schutz-Grund"-ver"-ord"-nung.
% *******************************************************************
