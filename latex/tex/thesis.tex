...
% Geben Sie allerdings digital ab, sollten Sie die Datei unterschrift.png in dem Ordner  
% /bilder durch einen Scan Ihrer eigenen Unteschrift ersetzen - andernfalls
...
\label{lastpage}
%Beginn des Anhangs. Befehl nicht entfernen auch wenn kein Anhang vorhanden ist!
\appendix
