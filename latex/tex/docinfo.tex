...
\DTMsavedate{Abgabe}{2023-08-24} % Datum der Abgabe
...
\setboolean{hsmapublizieren}{true}   % Wird einer Veröffentlichung zugestimmt? false=nein, true=ja
\setboolean{hsmasperrvermerk}{false} % Hat die Arbeit einen Sperrvermerk? false=nein, true=ja

% Verwendung eines Gender-Hinweises
\setboolean{genderhinweis}{true}     % Soll der Gender-Hinweis angezeigt werden? false=nein, true=ja
