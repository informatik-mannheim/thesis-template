...
\newcommand{\genderhinweis}{nogender}     % Soll der Gender-Hinweis angezeigt werden? ja=gender, nein = nogender; Genderhinweis wird nur in deutscher Sprache angezeigt!
...
\newcommand{\hsmatitelde}{Jenkins in einer Homeserverumgebung anhand eines D\&D Microservice Beispiels}

% Titel der Arbeit auf Englisch
\newcommand{\hsmatitelen}{Jenkins in a Homeserverenviroment based on a D\&D Microservice Example}

% Weitere Informationen zur Arbeit
\newcommand{\hsmaort}{Mannheim}          % Ort
\newcommand{\hsmaautorvname}{Gregory}        % Vorname(n)
\newcommand{\hsmaautornname}{Hammond} % Nachname(n)
\newcommand{\hsmaabgabedatum}{2025-06-12}% Datum der Abgabe in dem Format JJJJ-MM-TT
